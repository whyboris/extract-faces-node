...
const RELATIVE_IMAGE_PATH = './images2/13.jpg';
const CURRENT_NUMBER_OF_SCREENS = 13;  // the number of chunks the image is split into (20 screenshots for example) // HARDCODED FOR NOW
